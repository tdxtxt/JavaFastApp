package com.fastdev.ui.adapter.fragment;
 ...
 * @作者： ton
 * @创建时间： 2018\5\23 0023
 * @功能描述： 加载显示Fragment的ViewPagerAdapter基类 提供可以刷新的方法
 * @传入参数说明： 无
 * @返回参数说明： 无
 */
public class BaseFragmentPagerAdapter extends FragmentPagerAdapter {
    ...
    public BaseFragmentPagerAdapter(List<Pair<String,BaseFragment>> pairs, FragmentManager fm) {
        super(fm);
        mFragmentList = new ArrayList<>();
        titles = new ArrayList<>();
        for (Pair<String, BaseFragment> item : pairs){
            mFragmentList.add(item.second);
