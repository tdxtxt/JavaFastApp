...
public class NetworkHelper {
    ...
    public static void openWirelessSettings() {
        DevApp.getContext().startActivity(
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) DevApp.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) DevApp.getContext().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) DevApp.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        return cm != null
