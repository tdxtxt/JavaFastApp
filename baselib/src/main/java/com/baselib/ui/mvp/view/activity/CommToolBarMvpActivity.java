 ...
 * @返回参数说明：
 */
public abstract class CommToolBarMvpActivity<V extends BaseMvpView, P extends BaseMvpPresenter<V>> extends CommToolBarActivity implements PresenterProxyInterface<V,P>,BaseMvpView {

    private static final String PRESENTER_SAVE_KEY = "presenter_save_key";
    /**
     * 创建被代理对象,传入默认Presenter的工厂
     */
    private BaseMvpProxy<V,P> mProxy = new BaseMvpProxy<V,P>(PresenterMvpFactoryImpl.createFactory(getClass(),createPresenter()));
    ...
    public P createPresenter(){return null;}
    @Override
