package com.baselib.fanpermission;
...
//                        String denied = deniedString.substring(0, deniedString.length() - 1);
                        DialogHelper.createCommDialog(mContext,"警告!",checkConfig == null ? forceDeniedPermissionTips : checkConfig.getForceDeniedPermissionTips(),
                                false,false, null, new MenuDialogCallBack("确定"){
                                    @Override
